...
do
	...
	for i in $(eval echo "{1..$volumes}"); do echo "1" >> ${suboutdir}/${shell}_column.txt; done #remove this file after each subject iteration
    ...
    #remove ${outdir}/${shell}_column.txt before next subject iteration as it will only be appended
